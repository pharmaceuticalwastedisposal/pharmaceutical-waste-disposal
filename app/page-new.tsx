...
import { ComplianceDeadline } from "./components/client/ComplianceDeadline"
import { ScrollToFormButton } from "./components/client/ScrollToFormButton"
import { PhoneCallButton } from "./components/client/PhoneCallButton"
import { FloatingCTA } from "./components/client/FloatingCTA"
import { Clock, AlertCircle, Star, CheckCircle } from "./components/client/DynamicIcons"

// Dynamic imports for heavy components - Fixed for default exports
...
export default function HomePage() {
  ...
  return (
    <>
      {/* SEO-Optimized H1 with Primary Keyword - EXACTLY THE SAME */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              {/* Mobile CTA - Now using our client component */}
